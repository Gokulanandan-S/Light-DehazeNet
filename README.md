...
```
git clone https://github.com/Gokulanandan-S/Light-DehazeNet.git
cd Light-DehazeNet
```
...
### Training Dataset
For training we have used the Synthetic Hazy Dataset generated by [Boyi Li](https://sites.google.com/site/boyilics/website-builder/project-page) for single image dehazing task. The dataset can be downloaded using the following links. 
